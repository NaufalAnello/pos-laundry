...
// Backup file penuh berisi DB & rahasia — owner-only
router.get('/backup',   requireAdmin, ctrl.backup);          // before / and /:id
...
router.get('/template/:jenis',    requireAdmin, ctrl.getTemplate);
