exports.up = async function (knex) {
  // Template lama (sebelum perubahan clarity)
...
_— {nama_toko} —_`;
  ...
  // Template baru (dengan clarity: Total Tagihan bukan Total Bayar)
...
_— {nama_toko} —_`;
  ...
  if (current && current.nilai === oldTemplate) {
    ...
    console.log('✓ Template WA nota berhasil diupdate untuk clarity (Total Tagihan)');
  } else if (current) {
    console.log('⚠️ Template WA nota sudah dikustomisasi, tidak diupdate otomatis');
    console.log('   Ubah manual label "Total Bayar" → "Total Tagihan" di halaman Pengaturan');
  }
};
